...
pylab.plot(values, linewidth = 1)
pylab.title('whatever you like')
pylab.xlabel('the lable of x axis', fontsize ='xx-large')
pylab.ylabel('the lable of y axis', fontsize = 'x-small')
pylab.show()
